...
Ext.define('FREON.FeedPanel', {
    ...
    onRemoveFeedClick: function() {
        ...
        if (active) {
            ...
            this.feedremove(active.get('id'));
        }
    },

    feedremove: function (id) {
        Ext.Ajax.request({
            url: '/feeds/remove',
            params: {
                id: id
